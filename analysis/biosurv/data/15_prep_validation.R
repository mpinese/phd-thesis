...
GSE21501.gex = read.table("validation/GSE21501_series_matrix.txt.xz", sep = "\t", comment.char = "!", header = TRUE)
...
# Hard threshold at 80th percentile SD
temp.sd = apply(GSE21501.gex, 1, sd)
temp.sel = temp.sd > quantile(temp.sd, 0.8)
GSE21501.gex = GSE21501.gex[temp.sel,]
GSE21501.feat = GSE21501.feat[temp.sel,]
...
GSE28735.gex = read.table("validation/GSE28735_series_matrix.txt.xz", sep = "\t", comment.char = "!", header = TRUE)
...
# GSE17891.samp = t(read.table(pipe("xz -dc ../data/validation/GSE17891-GPL570_series_matrix.txt.xz | grep -E '^!Sample'"), sep = "\t"))
# colnames(GSE17891.samp) = gsub("^!", "", GSE17891.samp[1,])
# GSE17891.samp = data.frame(GSE17891.samp[-1,], check.names = TRUE)

# GSE17891 samples don't apply -- they're from microdissected tissue.
