...
\hlkwd{arrows}\hlstd{(}\hlkwc{x0} \hlstd{=} \hlkwd{mean}\hlstd{(xy[,} \hlnum{1}\hlstd{]),} \hlkwc{y0} \hlstd{=} \hlkwd{mean}\hlstd{(xy[,} \hlnum{2}\hlstd{]),} \hlkwc{x1} \hlstd{= temp[}\hlnum{1}\hlstd{, ]} \hlopt{+} \hlkwd{mean}\hlstd{(xy[,} \hlnum{1}\hlstd{]),}
    \hlkwc{y1} \hlstd{= temp[}\hlnum{2}\hlstd{, ]} \hlopt{+} \hlkwd{mean}\hlstd{(xy[,} \hlnum{2}\hlstd{]),} \hlkwc{col} \hlstd{=} \hlstr{"black"}\hlstd{,} \hlkwc{lwd} \hlstd{=} \hlnum{5}\hlstd{)}
\end{alltt}
\end{kframe}
...
\hlkwd{plot}\hlstd{(xy[subset,} \hlnum{1}\hlstd{], xy[subset,} \hlnum{2}\hlstd{],} \hlkwc{col} \hlstd{=} \hlstr{"black"}\hlstd{,} \hlkwc{pch} \hlstd{= pch[subset],} \hlkwc{xlab} \hlstd{=} \hlstr{"Gene 1"}\hlstd{,}
    \hlkwc{ylab} \hlstd{=} \hlstr{"Gene 2"}\hlstd{,} \hlkwc{xlim} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{1}\hlstd{),} \hlkwc{ylim} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{1}\hlstd{),} \hlkwc{asp} \hlstd{=} \hlnum{1}\hlstd{)}
