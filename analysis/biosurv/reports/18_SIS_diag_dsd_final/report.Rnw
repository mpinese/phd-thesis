...
opts_chunk$set(
	fig.align = 'center', dev = 'tikz', dev.args = list(pointsize = 11), cache = TRUE, cache.lazy = FALSE)
...
plot_km_axes(axis_coefs.diag_dsd[,1], axis_coefs.diag_dsd[,2], y.diag_dsd, mc = FALSE, main = "APGI (Resubstituted)")
