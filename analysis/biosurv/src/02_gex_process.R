...
sample_data = as.data.frame(read.table("../data/originals/garvan_sample_overview.tsv.xz", sep = "\t", quote = "", comment = "", header = TRUE))
...
save(sample_data, probe_raw, file = "../data/02_gex.rda", compress = "gzip", compression_level = 4)
