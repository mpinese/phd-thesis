...
print(APGI.messina)
pdf("07_E3_best.pdf", height = 10, width = 10)
...
print(messina:::messinaSurvObjPlot(APGI.messina, i) + geom_rug(aes(x = x), data = data.frame(x = APGI.x["KRT6A",], Objective = 0, Alpha = 0.25), sides = "b", size = 1.5))
print(messina:::messinaSurvKMplot(y = APGI.y, group = (APGI.x["KRT6A",] > APGI.messina@fits@summary$threshold[i])*1, bootstrap_type = "ci", bootstrap_ci = 0.9, nboot = 500, parallel = FALSE) + ggtitle("Separation at Threshold") + theme(legend.position = "bottom"))
...
print(messina:::messinaSurvObjPlot(APGI.messina, i) + geom_rug(aes(x = x), data = data.frame(x = APGI.x["ANGPTL4",], Objective = 0, Alpha = 0.25), sides = "b", size = 1.5))
print(messina:::messinaSurvKMplot(y = APGI.y, group = (APGI.x["ANGPTL4",] > APGI.messina@fits@summary$threshold[i])*1, bootstrap_type = "ci", bootstrap_ci = 0.9, nboot = 500, parallel = FALSE) + ggtitle("Separation at Threshold") + theme(legend.position = "bottom"))
...
print(messina:::messinaSurvObjPlot(APGI.messina, i) + geom_rug(aes(x = x), data = data.frame(x = APGI.x["KRT6C",], Objective = 0, Alpha = 0.25), sides = "b", size = 1.5))
print(messina:::messinaSurvKMplot(y = APGI.y, group = (APGI.x["KRT6C",] > APGI.messina@fits@summary$threshold[i])*1, bootstrap_type = "ci", bootstrap_ci = 0.9, nboot = 500, parallel = FALSE) + ggtitle("Separation at Threshold") + theme(legend.position = "bottom"))
