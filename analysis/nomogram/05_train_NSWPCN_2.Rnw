...
scatter.smooth(resid(fit.cph, type = "deviance"), data$SizeCent)
boxplot(resid(fit.cph, type = "deviance") ~ data$A2, main = "Deviance vs A2")
boxplot(resid(fit.cph, type = "deviance") ~ data$A4, main = "Deviance vs A4")
