...
par(mfrow = c(4, 1), mar = c(5.1, 5.1, 4.1, 2.1))
...
hist(gg.linpred.nswpcn, main = "NSWPCN", xlim = range(c(gg.linpred.nswpcn, gg.linpred.glasgow, gg.linpred.apgi, gg.linpred.dresden)), breaks = temp.breaks, col = "lightgrey", xlab = "", cex.axis = 2, cex.lab = 2, cex.main = 2)
abline(v = quantile(gg.linpred.nswpcn, probs = c(0.2, 0.5, 0.8)), col = rgb(1, 0, 0, 0.8), lwd = 4, lty = "dashed")
hist(gg.linpred.glasgow, main = "Glasgow", xlim = range(c(gg.linpred.nswpcn, gg.linpred.glasgow, gg.linpred.apgi, gg.linpred.dresden)), breaks = temp.breaks, col = "lightgrey", xlab = "", cex.axis = 2, cex.lab = 2, cex.main = 2)
abline(v = quantile(gg.linpred.glasgow, probs = c(0.2, 0.5, 0.8)), col = rgb(1, 0, 0, 0.8), lwd = 4, lty = "dashed")
hist(gg.linpred.apgi, main = "APGI", xlim = range(c(gg.linpred.nswpcn, gg.linpred.glasgow, gg.linpred.apgi, gg.linpred.dresden)), breaks = temp.breaks, col = "lightgrey", xlab = "", cex.axis = 2, cex.lab = 2, cex.main = 2)
abline(v = quantile(gg.linpred.apgi, probs = c(0.2, 0.5, 0.8)), col = rgb(1, 0, 0, 0.8), lwd = 4, lty = "dashed")
hist(gg.linpred.dresden, main = "Dresden", xlim = range(c(gg.linpred.nswpcn, gg.linpred.glasgow, gg.linpred.apgi, gg.linpred.dresden)), breaks = temp.breaks, col = "lightgrey", xlab = "", cex.axis = 2, cex.lab = 2, cex.main = 2)
abline(v = quantile(gg.linpred.dresden, probs = c(0.2, 0.5, 0.8)), col = rgb(1, 0, 0, 0.8), lwd = 4, lty = "dashed")
par(pars)
@
...
plot(0 ~ 0, type = "n", xlim = c(0, 5*12), ylim = c(0, 1), xlab = "Time from diagnosis (months)", ylab = "Fraction alive", cex.lab = 1.5, cex.axis = 1.5)
...
plot(gg.path.glasgow.brier$eval_times/365.25*12, gg.path.glasgow.brier$bsc, col = pal["gg"], type = "l", ylim = c(0, 0.3), xlab = "Time from diagnosis (months)", ylab = "Brier score", lwd = 3, xlim = c(0, 40), cex.lab = 1.5, cex.axis = 1.5)
lines(gg.path.glasgow.brier$eval_times/365.25*12, km0.path.glasgow.brier$bsc, col = pal["km0"], lwd = 3)
...
abline(h = 0.25, col = "grey", lty = "dashed")
abline(v = c(7, 34), lty = "dashed")
legend("bottom", 
	legend = c(	"PCOP", 		"KM0", 		"MSKCC"), 
	pch = c(	NA, 			NA, 		16), 
	col = c(	pal["gg"], 		pal["km0"], pal["mskcc.pre"]), 
	lty = c(	"solid", 		"solid", 	NA), 
	inset = 0.05, lwd = 3, bty = "n")
@


<<prob-bs-paths-plot-apgi, fig.height = 4, fig.width = 6>>=
plot(gg.path.apgi.brier$eval_times/365.25*12, gg.path.apgi.brier$bsc, col = pal["gg"], type = "l", ylim = c(0, 0.3), xlab = "Time from diagnosis (months)", ylab = "Brier score", lwd = 3, xlim = c(0, 40), cex.axis = 1.5, cex.lab = 1.5)
lines(gg.path.apgi.brier$eval_times/365.25*12, km0.path.apgi.brier$bsc, col = pal["km0"], lwd = 3)
...
plot(gg.path.dresden.brier$eval_times/365.25*12, gg.path.dresden.brier$bsc, col = pal["gg"], type = "l", ylim = c(0, 0.3), xlab = "Time from diagnosis (months)", ylab = "Brier score", lwd = 3, xlim = c(0, 40), cex.axis = 1.5, cex.lab = 1.5)
lines(gg.path.dresden.brier$eval_times/365.25*12, km0.path.dresden.brier$bsc, col = pal["km0"], lwd = 3)
...
plot(rrROC_boot.mskcc_pre.glasgow, col = pal["mskcc.pre"], xlab = "Time from diagnosis (months)", ylab = "AUC", lwd = 3, cex.lab = 1.5, cex.axis = 1.5)
plot(rrROC_boot.gg.glasgow, col = pal["gg"], add = TRUE, ci = TRUE, lwd = 3)
legend("topright", legend = c("MSKCC", "PCOP"), col = c(pal["mskcc.pre"], pal["gg"]), lty = "solid", lwd = 3, inset = 0.05, bty = "n")
...
plot(rrROC_boot.mskcc_pre.apgi, col = pal["mskcc.pre"], xlab = "Time from diagnosis (months)", ylab = "AUC", lwd = 3, cex.lab = 1.5, cex.axis = 1.5)
...
plot(rrROC_boot.mskcc_pre.dresden, col = pal["mskcc.pre"], xlab = "Time from diagnosis (months)", ylab = "AUC", lwd = 3, cex.lab = 1.5, cex.axis = 1.5)
