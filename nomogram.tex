...
\mpfatal{TODO: Year variable -- exclude as prognostic?  At least model it and then make predictions as at current time}
\mpfatal{Decide what to do with the models.  At the moment, I have CPH from genetic AS, and GG from stepwise.  This doesn't make sense.  Choose one for both.  I think stepwise AIC is the best option.}
