...
TODO -- summary para?
% This chapter described the development and validation of a pilot pre-operative prognostic for resectable pancreas cancer, the \gls{PCOP}.  The \gls{PCOP} is intended to aid in the decision of whether or not to resect a given patient's pancreas cancer, 
