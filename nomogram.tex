...
Disease-specific death &         & 95.2\%        & 68.0\%       & 74.7\%       & 85.2\%         \\[3]
...
\centering
  \subbottom[Glasgow]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-prob-bs-paths-plot-glasgow-2}
    \label{fig:nomo-val-brier-glasgow}}
  \subbottom[APGI]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-prob-bs-paths-plot-apgi-2}
    \label{fig:nomo-val-brier-apgi}}
  \subbottom[Dresden]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-prob-bs-paths-plot-dresden-2}
...
\centering
  \subbottom[Glasgow]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-risksetROC-glasgow-2}
    \label{fig:nomo-val-tdroc-glasgow}}
  \subbottom[APGI]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-risksetROC-apgi-2}
    \label{fig:nomo-val-tdroc-apgi}}
  \subbottom[Dresden]{
    \includegraphics[width=.45\linewidth]{analysis/nomogram/figure/07-risksetROC-dresden-2}
...
\mpfatal{Get a proper domain name?}
