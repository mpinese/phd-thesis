...
\begin{figure}
  ...
  \subbottom[\acrshort{PCA}]{
    \includegraphics[width=.3\textwidth]{analysis/biosurv/reports/PCA_ICA_NMF_comparison/figure/plots-2}
    \label{fig:sigs-example-matrixfactor-methods-pca}}
  \subbottom[\acrshort{ICA}]{
    \includegraphics[width=.3\textwidth]{analysis/biosurv/reports/PCA_ICA_NMF_comparison/figure/plots-3}
    \label{fig:sigs-example-matrixfactor-methods-ica}}
  \subbottom[\acrshort{NMF}]{
    \includegraphics[width=.3\textwidth]{analysis/biosurv/reports/PCA_ICA_NMF_comparison/figure/plots-4}
...
Location                   & Head                     & 64.0\%                   & 84.6\%                                                 \\
                           ...
                           & Tail                     & 11.0\%                   & 8.2\%                                                  \\
                           & Body                     & 5.7\%                    & 6.4\%                                                  \\
Length                & (mm)                     & 33.0 (24.5 - 45.0)       & 35.0 (28.0 - 45.0)                                     \\
...
\mpfatal{TODO: Consider comparing A1 and A2 vs meta-PCNA and meta-ECM in TCGA -- are A1/A2 better than the metas?  Model complexity is the same so therefore can just compare partials -- woo}

\section{Discussion}
At the molecular level, the phenomenon of cancer has long been recognised as a composite of many processes \cite{Hanahan2011}, however the relative importance of each process to a particular type of cancer has been largely uncertain.  In pancreas cancer, a huge number of individual biomarkers are known \cite{Harsha2009}, and some attempts have been made to stratify cancers into empirical molecular subtypes \cite{Collisson2011}, but no studies have provided a comprehensive analysis of which basic hallmarks of cancer are actually important in determining patient outcome.  This work fills that gap in knowledge, and is the first to exhaustively identify proliferation and the \gls{EMT} as the major molecular processes that control survival of patients with pancreas cancer.

\begin{itemize}
  \item PARSE = meta-PCNA + meta-EMT (+ immune + stroma?).
  \item Context-dependency of stroma signal
  \item The folly of clustering
  \item GSE21501 -- why didn't it validate?
  \item Broader implications of pan-cancer survival signature
  \item Relevance to future work.
\end{itemize}
